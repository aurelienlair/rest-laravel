...
Route::group([/*'middleware' => 'auth.basic'*/], function () {
    ...
    Route::get('/actors/{id}', 'ActorController@show')->where('id', '[a-f0-9]{8}\-[a-f0-9]{4}\-4[a-f0-9]{3}\-(8|9|a|b)[a-f0-9]{3}\-[a-f0-9]{12}');
    ...
    })->where('id', '[a-f0-9]{8}\-[a-f0-9]{4}\-4[a-f0-9]{3}\-(8|9|a|b)[a-f0-9]{3}\-[a-f0-9]{12}');
});
